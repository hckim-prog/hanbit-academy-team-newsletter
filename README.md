...
여러 업무보고를 합칠 때는 완전히 같거나 사실상 같은 문장을 한 번만 남깁니다. 성과·기회는 `반짝 소식`, 진행 업무는 `집중 모드`, 약한 신호·리스크는 `체크 포인트`, 향후 계획은 `다음 2주`에 우선 배치합니다. 한입 요약은 본문 문장을 복사하지 않고 전체 구성을 안내하는 독립 문장으로 만듭니다.
